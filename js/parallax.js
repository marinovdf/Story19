...
$(document).ready(function () {
    ...
    function Move() {
        ...
        if ($bg1.hasClass("inview")) {
            bg1.css({'backgroundPosition': newPos(50, windowHeight, pos, -1800, 0.3)});
        }
        if ($bg2.hasClass("inview")) {
            bg2.css({'backgroundPosition': newPos(50, windowHeight, pos, -300, -0.25)});
        }
        if ($bg3.hasClass("inview")) {
            bg3.css({'backgroundPosition': newPos(50, windowHeight, pos, 800, 0.15)});
        }
        if ($bg4.hasClass("inview")) {
            bg4.css({'backgroundPosition': newPos(50, windowHeight, pos, -400, -0.15)});
        }
        if ($bg5.hasClass("inview")) {
            bg5.css({'backgroundPosition': newPos(50, windowHeight, pos, -1500, 0.2)});
        }
